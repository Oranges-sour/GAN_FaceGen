...
optimizer_G = optim.Adam(generator_net.parameters(), lr=0.001, weight_decay=1e-6)
optimizer_D = optim.Adam(discriminator_net.parameters(), lr=0.000002, weight_decay=1e-6)
